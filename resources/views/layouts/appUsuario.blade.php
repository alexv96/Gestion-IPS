      ...
      <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu extended logout">
            <li><a href="{{ url('particular/'.session('idUsuario').'/edit')}}"><i class=" fa fa-suitcase"></i>Perfil</a></li>
            <li><a href="{{ url('/logoutUsuario') }}"><i class="fa fa-key"></i> Cerrar Sesion</a></li>
          </ul>
        </li>
